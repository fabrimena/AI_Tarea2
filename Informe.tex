...
seis características seleccionadas, dado que en los boxplots de sulfatos y de densidad (ver Fig.~\ref{fig:boxplot_sulfate} y Fig.~\ref{fig:boxplot_density}) se observan valores atípicos. En el cuaderno se aplica el criterio del
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{images/volatile_acidity_vs_quality.png}
